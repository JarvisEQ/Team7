...
class ReplayBuffer:
    ...
    def __init__(self, 
         ...
         self.reward_critic_buffy = np.zeros([size], dtype=np.float32)
    ...
    def store_transition(self,
        ...
        self.reward_critic_buffy[self.pointer] = reward_crtic
    ...
    def get_sample(self):
        ...
        sample = dict(init_state = self.init_state_buffy[indexes],
                     ...
                     reward_critic = self.reward_critic_buffy[indexes],
